...
---
As a consultant, I regulary work for many customers in addition to internal projects and even some personal ones on GitHub or else.
...
Nothing extraordinary, but during many years, I have always used the same email address for all my commits. Nothing blocking. By default, almost every git system are not configured to validate the mails associated with commits. Authentication 
